...
url_nfl2016_1 = 'https://www.vegasinsider.com/nfl/matchups/matchups.cfm/week/'
url_nfl2016_2 = '/season/2016'

for i in range(1,23):
    r = requests.get(url_nfl2016_1 + str(i) + url_nfl2016_2)
    ...
    empty_row = {
        ...
        "Consensus_Money": None,"Consensus_OU": None, "Season": 2016, "Week": i
    }
