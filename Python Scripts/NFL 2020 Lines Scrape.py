...
url_nfl2020_1 = 'https://www.vegasinsider.com/nfl/matchups/matchups.cfm/week/'
url_nfl2020_2 = '/season/2020'

for i in range(1,8):
    r = requests.get(url_nfl2020_1 + str(i) + url_nfl2020_2)
    ...
    empty_row = {
        ...
        "Consensus_Money": None,"Consensus_OU": None, "Season": 2020, "Week": i
    }
