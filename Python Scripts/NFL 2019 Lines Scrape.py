...
url_nfl2019_1 = 'https://www.vegasinsider.com/nfl/matchups/matchups.cfm/week/'
url_nfl2019_2 = '/season/2019'

for i in range(1,23):
    r = requests.get(url_nfl2019_1 + str(i) + url_nfl2019_2)
    ...
    empty_row = {
        ...
        "Consensus_Money": None,"Consensus_OU": None, "Season": 2019, "Week": i
    }
